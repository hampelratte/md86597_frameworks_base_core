...
public class Intent implements Parcelable, Cloneable {
	...
	/* [BEGIN] Willie added for get auto time mode broadcast [2010-09-07]*/
	/**
     * Broadcast Action: The time mode has changed.
     * @hide
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_TIME_MODE = "android.intent.action.TIME_MODE";
	/* [END] */
    /**
   ...
   /**
     * Broadcast Action:  Request the media scanner to enabled.
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_MEDIA_DATABASE_ENABLED = "com.skyviia.intent.action.MEDIA_DATABASE_ENABLED";

   /**
     * Broadcast Action:  Request the media scanner to disabled.
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_MEDIA_DATABASE_DISABLED = "com.skyviia.intent.action.MEDIA_DATABASE_DISABLED";
   ...
   /**
	...
	//add receive shwo PVR Record info By minchay_0170 20110802
	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
	public static final String REC_HEAD             = "PVRC";
	
	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_USER_START       = "0";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_USER_STOP        = "1";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_TIMER_UPDATE     = "2";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_TIMER_AGREE      = "3";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_TIMER_DISAGREE   = "4";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_TIMER_START      = "5";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_TIMER_STOP       = "6";

	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_TIMER_AUTO_START = "7";

    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_TIMEZONE_UPDATE  = "8";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_BACK_DVBT        = "9";        
	
	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_USER_30MIN           = "10";   
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_USER_60MIN           = "11";   
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_USER_120MIN          = "12";   
            	
	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_ERR_USER_START   = "100";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_ERR_USER_STOP    = "101";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_ERR_TIMER_START  = "102";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_ERR_TIMER_STOP   = "103";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_ERR_TIMER_UPDATE = "104";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)   
    public static final String REC_ERR_TIMER_AGREE  = "105";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_ERR_TIMER_DISAGREE = "106";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_ERR_TIMER_AUTO_START = "107";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_ERR_STORAGE_FULL = "108";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_STATUS_GET       ="200";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_STATUS_USER_OFF  ="201";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_STATUS_USER_ON   ="202";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_STATUS_TIMER_OFF ="203";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_STATUS_TIMER_WAIT="204";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_STATUS_TIMER_ON  ="205";
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_STATUS_WAIT_AGREE  ="206"; 
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_STATUS_30MIN         ="207"; 
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_STATUS_60MIN         ="208"; 
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String REC_STATUS_120MIN        ="209";    
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String TS_STATUS_WRITE_START    ="300";    
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String TS_STATUS_WRITE_END      ="301";    
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String TS_STATUS_CHECK_ALIVE    ="302";    
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String TS_STATUS_ALIVE          ="303";    
    
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String TS_STATUS_DIE            ="304";                                 
	//add receive shwo PVR Record info By minchay_0170 20110802
	
	//add Video Information Callback define tag By Minchay_0185 20110819
	@SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String VIDEO_INFO_TYPE_TAG       ="VideoType";  
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String VIDEO_INFO_RESOLUTION_TAG ="Resolution";  
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String VIDEO_INFO_FRAME_RATE_TAG ="FrameRate";  
	//add Video Information Callback define tag end By Minchay_0185 20110819
