...
public class NumberPicker extends LinearLayout {
    ...
    public NumberPicker(Context context, AttributeSet attrs) {
        ...
        OnClickListener clickListener = new OnClickListener() {
            public void onClick(View v) {
				...
				// [BEGIN] Willie remove for click increment/decrement 
				// then do not change focus to edit text [2010-12-01]
    ...
    public void setEditTextFocusable(boolean enabled) {
	...
	// [BEGIN] Willie added for set edit text requestFocus [2010-12-23]
	/**
     * @hide
     */
