...
// [BEGIN] Modify key in TAB key event [Willie][2011-06-09]
...
public class QwertyKeyListener extends BaseKeyListener {
   ...
   /**
     ...
     */
    public boolean performEditorAction(View view,int actionCode) {
        long eventTime = SystemClock.uptimeMillis();
        sendKeyEvent(view,new KeyEvent(eventTime, eventTime,
                KeyEvent.ACTION_DOWN, KeyEvent.KEYCODE_ENTER, 0, 0, 0, 0,
                KeyEvent.FLAG_SOFT_KEYBOARD | KeyEvent.FLAG_KEEP_TOUCH_MODE
                | KeyEvent.FLAG_EDITOR_ACTION));
        sendKeyEvent(view,new KeyEvent(SystemClock.uptimeMillis(), eventTime,
