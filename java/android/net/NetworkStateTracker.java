...
public abstract class NetworkStateTracker extends Handler {
	...
	// [BEGIN] Willie added for send has network ip [2011-02-15]
	public static final int EVENT_HAS_NETWORK_IP = 8;
	// [END]
   ...
   public void updateNetworkSettings() {
	...
	// [BEGIN] Willie added for send get ip boardcast [2011-02-15]
	/**
     * Network connectivity had occurred. 
     * @param hasnetworkip network is complete 
	*/
	public void hasNetworkIP(boolean hasnetworkip) {
		Message msg = mTarget.obtainMessage(EVENT_HAS_NETWORK_IP);
        msg.sendToTarget();
	}
	// [END]
}
