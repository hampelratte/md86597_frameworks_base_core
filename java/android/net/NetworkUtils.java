...
public class NetworkUtils {
   ...
   // [BEGIN] Add PPPoE ethernet mode [Willie][2011-06-30]
   /**
     * Start the PPPoE service.
     */
    public native static int runPPPoE(String name, String password);
   /**
     * Stop the PPPoE service.
     */
    public native static boolean stopPPPoE();
    /**
     * Return the PPPoE interface name.
     * @return the PPPoE interface name, if any
     */
    public native static String getPppoeIfname();
   /**
     * Return the PPPoE IP address.
     * @return the PPPoE IP address, if any
     */
    public native static String getPppoeIp();
   /**
     * Return the PPPoE gateway address.
     * @return the PPPoE gateway address, if any
     */
    public native static String getPppoeGateway();
    /**
     * Return the PPPoE DNS1 address.
     * @return the PPPoE DNS1 address, if any
     */
    public native static String getPppoeDns1();
	/**
     * Return the PPPoE DNS2 address.
     * @return the PPPoE DNS2 address, if any
     */
    public native static String getPppoeDns2();

	
	/**
		* When PPPoE configuration has been specified, configure the network
		* interface according to the values supplied.
		* @param interfaceName the name of the interface to configure
		* @param ipInfo the DNS server addresses with which to configure the interface.
		* @return {@code true} for success, {@code false} for failure
		*/
	   public static boolean PPPoEconfigureInterface(String interfaceName, DhcpInfo ipInfo) {
		   return PPPoEconfigureNative(interfaceName,
			   ipInfo.dns1,
			   ipInfo.dns2);
	   }
	
	   private native static boolean PPPoEconfigureNative(
		   String interfaceName, int dns1, int dns2);
   // [END]
    /**
