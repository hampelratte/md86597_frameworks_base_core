...
public class ConnectivityManager
{
	...
	// [BEGIN] Willie added for has network ip broadcast [2011-02-15]
	/**
	* A network conntivity complete has occurred. 
	*/
	public static final String HAS_NETWORK_IP_ACTION = "android.net.conn.HAS_NETWORK_IP";
	// [END]
    /**
...
// [BEGIN] skyviia modify: pull in ethernet manager!
    /**
     * The Default Ethernet connection.
     */
