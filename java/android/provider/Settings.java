...
/**
	 * 20101126 : add by Ethan A3 for "Volume IDr"
	...
	/**
	 * 20091201 : add by Ethan chen for "Device Selector"
	 * User selected device.
	 * @hide
	 */
	...
	/**
	 * 20111028 : add by Minchay_0302 for "Device Selector result"
	 * User selected device.
	 * @hide
	 */
	public static final String SELECTED_DEVICE_RESULT= "selected_device_result";
	
	/**
	 * 20100402 : add by Ethan chen for "DLNA firnedly name"
	 * User selected DLNA firnedly name.
	 * @hide
	 */
	public static final String DLNA_FRIENDLY_NAME= "dlna_driendly_name";	

	
	/**
         * The UUID of current selected DLNA server.
	 */
	public static final String DLNA_UUID= "dlna_uuid";
	
	/**
	 * 20100402 : add by Ethan chen for "DLNA location URL"
	 * User selected DLNA location URL.
	 * @hide
	 */
...
// [BEGIN] skyviia modify:
//         [Willie Chen] added 2009/10/01 for sound settings

        /**
          * The analog audio channel mode selected
          *@hide
          */
        public static final String CHANNEL_MODE = "channel_mode";

        /**
          * The digital audio out selected
          *@hide
          */
        public static final String AUDIO_DIGITAL_OUTPUT = "audio_digital_output";

        /**
          * The digital audio out selected
          *@hide
          */
        public static final String DISPLAY_DIGITAL_OUTPUT = "display_digital_output";
// [END]

//[BEGIN] Add for turning on/off media database in Settings. (Skyviia-Michael Jan. 18, 2011)
        /**
          * Usability of media database
          *@hide
          */
        public static final String ENABLE_MEDIA_DATABASE = "enable_media_database";
//[END] Add for turning on/off media database in Settings

//[BEGIN] Add for save aspect ratio size in Settings. (Skyviia-Willie Mar. 10, 2011)
	  /**
...
//[BEGIN] Add for Dolby items in Sound Settings. (Skyviia-Willie Apr. 13. 2011)
      /**
	   * The Dolby enable
	   *@hide
	   */
	  public static final String DOLBY_ON = "dolby_on";
      /**
          * The Dolby output selected
          *@hide
          */
      public static final String DOLBY_OUTPUT = "dolby_output";

      /**
          * The Dolby stereo selected
          *@hide
          */
      public static final String DOLBY_STEREO = "dolby_stereo";

	  /**
          * The Dolby compression selected
          *@hide
          */
      public static final String DOLBY_COMPRESSION = "dolby_compression";

	  /**
          * The Dolby DRC selected
          *@hide
          */
      public static final String DOLBY_DRC = "dolby_drc";

	  /**
          * The Dolby Dual Mono selected
          *@hide
          */
      public static final String DOLBY_DUAL_MONO = "dolby_dual_mono";

//[END]

//[BEGIN] Add for DTS items in Sound Settings. (Skyviia-Willie Apr. 13, 2011)
      /**
	   * The DTS enable
	   *@hide
	   */
	  public static final String DTS_ON = "dts_on";
	  /**
	   * The DTS DRC selected
	   *@hide
	   */
	  public static final String DTS_DRC = "dts_drc";

      /**
	   * The DTS SPEAK selected
	   *@hide
	   */
	  public static final String DTS_SPEAK = "dts_speak";

	  /**
	   * The DTS LFE selected
	   *@hide
	   */
	  public static final String DTS_LFE = "dts_lfe";

	  /**
	   * The DTS Bass selected
	   *@hide
	   */
	  public static final String DTS_BASS = "dts_bass";
//[END]
        ...
        // [BEGIN] Mantis #5919 (YenMao): New saved volume string.
        /**
         * Save volume before volume goes mute or unmute. This attribute
         * serves two purposes: Restore to last-known index when volume goes unmute;
         * and determine current volume is in mute/unmute state. (value of -1 means
         * current volume is unmute)
         *
         * @hide
         */
        ...
        // [BEGIN] skyviia modify: [Willie Chen] [2009/09/18] Set GMAC DHCP funcion.
        /**
          * Set GMAC DHCP funcion.
          * @hide
          */
        public static final String GMAC_DHCP = "gmac_dhcp";
        // [END]
        ...
        /**
         * URI for the "lcn on /off ".
         * @hide
         */
        public static final String LCN_ON_OFF = "lcn_on_off";/* denny@20110605 for adding the lcn function */

        /**
         * URI for the "parental rating".
         * @hide
         */
        public static final String PARENTAL_RATING = "parental_rating";/* denny@20110609 for adding the parental control function */

        /**
         * URI for the "parental password".
         * @hide
         */
        public static final String PARENTAL_PASSWORD = "parental_password";/* denny@20110609 for adding the parental control function */
        ...
        public static final String[] SETTINGS_TO_BACKUP = {
            ...
            LCN_ON_OFF,/* denny@20110605 for adding the lcn function */
            PARENTAL_RATING,/* denny@20110609 for adding the parental control function */
            PARENTAL_PASSWORD,/* denny@20110609 for adding the parental control function */
...
// [BEGIN] skyviia modify: pull in etherner settings in setting provider!
        /*
	...
	public static final String ETH_MACADDRESS  = "eth_macaddr";
	public static final String ETH_PPPOE_NAME  = "eth_pppoe_name";
	public static final String ETH_PPPOE_PASSWORD  = "eth_pppoe_password";
// [END]
