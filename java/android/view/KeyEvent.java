...
public class KeyEvent implements Parcelable {
    ...
    // [BEGIN] skyviia modify: add for Skyviia RCU.
    public static final int KEYCODE_ZOOM          = 92;
    public static final int KEYCODE_TVRES         = 93;
    public static final int KEYCODE_ROTATE        = 94;
    public static final int KEYCODE_SKBONOFF      = 95;
    public static final int KEYCODE_REPEAT        = 96;
    public static final int KEYCODE_SLIDESHOW     = 97;
    public static final int KEYCODE_INFO      	  = 98;
    public static final int KEYCODE_ALL           = 99;
    public static final int KEYCODE_MUSIC         = 100;
    public static final int KEYCODE_PHOTO         = 101;
    public static final int KEYCODE_MOVIE         = 102;
    public static final int KEYCODE_ZOOM_IN       = 103;
    public static final int KEYCODE_ZOOM_OUT      = 104;
    public static final int KEYCODE_PAUSE_STEP    = 105;
    public static final int KEYCODE_PLAY          = 106;
    public static final int KEYCODE_REP_1ORALL    = 107;
    public static final int KEYCODE_REP_ABMODE    = 108;
    public static final int KEYCODE_SLOW          = 109;
    public static final int KEYCODE_INS_REPLAY    = 110;
    public static final int KEYCODE_CM_SKIP       = 111;
    public static final int KEYCODE_EDIT          = 112;
    public static final int KEYCODE_SPK_LEFT_RIGHT= 113;
    public static final int KEYCODE_RED_KEY       = 114;
    public static final int KEYCODE_GREEN_KEY     = 115;
    public static final int KEYCODE_YELLOW_KEY    = 116;
    public static final int KEYCODE_BLUE_KEY      = 117;
    // [END]
    //[begin]
    public static final int KEYCODE_PAGE_UP    = 118;
    public static final int KEYCODE_PAGE_DOWN      = 119;
    // [END]
	//sjlin
    public static final int KEYCODE_GADGET_CONNECT      = 120;
    public static final int KEYCODE_GADGET_DISCONNECT      = 121;
    //Devi Chen    
    public static final int KEYCODE_CTRL_LEFT     = 122;
    public static final int KEYCODE_CTRL_RIGHT    = 123;
    public static final int KEYCODE_CAPS      	  = 124;
    //Rock Huang add for sulang
    public static final int KEYCODE_TV_RADIO      = 125;
    public static final int KEYCODE_TXT      	  = 126;
    public static final int KEYCODE_SUB      	  = 127;
    public static final int KEYCODE_EPG      	  = 128;
    public static final int KEYCODE_FAV      	  = 129;
    public static final int KEYCODE_REC      	  = 130;
    public static final int KEYCODE_AUDIO      	  = 131;
    public static final int KEYCODE_CH_INC	      = 132;
    public static final int KEYCODE_CH_DEC     	  = 133;
    public static final int KEYCODE_ASTERISK      = 134;
    public static final int KEYCODE_HASH      	  = 135;
	public static final int KEYCODE_TV      	  = 136;
	public static final int KEYCODE_RECALL        = 137;
    //Rock add end
    ...
    // [BEGIN] skyviia modify: add for Skymedi RCU.
    //private static final int LAST_KEYCODE           = KEYCODE_MUTE;
    //private static final int LAST_KEYCODE           = KEYCODE_BLUE_KEY;
    // [BEGIN] skyviia modify: add for Browser page up & down.
...
/**
     ...
     * @hide
     */
    public KeyEvent( int action,  int code, int repeat, int metaState, int scancode, int flags) {
                mAction = action;
        mKeyCode = code;
        mRepeatCount = repeat;
...
//[2010-12-14][end]
    ...
    public final boolean isSystem() {
        ...
        case KEYCODE_TVRES:
        case KEYCODE_ROTATE:
        case KEYCODE_SKBONOFF:
        case KEYCODE_REPEAT:
        case KEYCODE_SLIDESHOW:
        case KEYCODE_INFO:
        case KEYCODE_ALL:
        case KEYCODE_MUSIC:
        case KEYCODE_PHOTO:
        ...
        case KEYCODE_PAUSE_STEP:
        case KEYCODE_PLAY:
        case KEYCODE_REP_1ORALL:
        case KEYCODE_REP_ABMODE:
        case KEYCODE_SLOW:
        case KEYCODE_INS_REPLAY:
        case KEYCODE_CM_SKIP:
        case KEYCODE_EDIT:
        case KEYCODE_SPK_LEFT_RIGHT:
        case KEYCODE_RED_KEY:
        case KEYCODE_GREEN_KEY:
        case KEYCODE_YELLOW_KEY:
        case KEYCODE_BLUE_KEY:
        // [END]
         // [BEGIN] skyviia modify: add for Browser page up & down.
        case KEYCODE_PAGE_UP:
        case KEYCODE_PAGE_DOWN:
	 // [END] skyviia modify: add for Browser page up & down.
		//sjlin
        case KEYCODE_GADGET_CONNECT:
        case KEYCODE_GADGET_DISCONNECT:
        //rockhuang add for sulang
        case KEYCODE_TV_RADIO:
        case KEYCODE_TXT:
        case KEYCODE_SUB:
        case KEYCODE_EPG:
        case KEYCODE_FAV:
