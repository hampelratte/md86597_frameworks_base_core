...
//import com.skyviia.util.DisplayUtil;
...
public class VolumePanel extends Handler
{
    ...
    protected void onShowVolumeChanged(int streamType, int flags) {
        //[skyviia modify] Disable VolumePanel while playing fullscreen video, Michael Tsai 10/28/10
        //if(DisplayUtil.isDisplayLocked()) {
        //    Log.d(TAG, "Turn off VolumePanel while the android display is locked.");
        //    return;
       // }
        //[END]
