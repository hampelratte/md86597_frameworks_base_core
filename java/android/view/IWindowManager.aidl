...
interface IWindowManager
{
    ...
    // [BEGIN] skyviia modify: For software cursor & set display mode
    /**
     * Enable the software cursor or not.
     * @param bEnable Setting as true if enabling software cursor. Setting as falsee if disabling it.
     */
    void enableCursor(in boolean bEnable);

    /**
     * Set the current display mode, constants as per
     * {@link android.view.Surface}.
     * @param dpy The display plane which we are going to set display mode.
     * @param mode The new display mode.
     * @hide
     */
    void setDisplayMode(int dpy, int mode); //int mode);
    // [END]
}
