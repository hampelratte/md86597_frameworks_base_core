...
// [BEGIN] skyviia modify: set Display Mode
     ...
     * {@hide}
     */
    public static native void setDisplayMode(int display, int mode);

    /**
      * set the cursor bitmap to driver.
      * @param bmp232Cursor
      * {@hide}
      */
    public static native void setCursorBmp(byte [] bmp232Cursor, int size);

    /**
      * set the cursor position to driver.
      * @param enable
      * @param x
      * @param y
      * @param alpha
      * {@hide}
      */
    public static native void setCursorPos(int enable, int x, int y, int alpha);
// [END]
